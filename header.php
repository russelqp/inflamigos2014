         ...
         <p>Y toda la Riviera Maya | <strong class="icon-phone"> 9841416137</strong></p>
              ...
              <nav>
                <ul>
                    ...
                    <li id="bk-mobiliarioytoldos" <?php if ($btn_activo == "toldos") {echo 'class="btn_activo"';} ?>><a href="<?php echo $Myurl; ?>mobiliario-y-toldos/" title="Renta de Mobiliario y toldos =)">Mobiliario y Toldos</a></li>
