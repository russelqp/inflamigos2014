            ...
            <?php $btn_activo;?>
              <nav>
                <ul>
                    ...
                    <li id="bk-mobiliario-y-toldos" <?php if ($btn_activo == "toldos") {echo 'class="btn_activo"';} ?>><a href="<?php echo $Myurl; ?>mobiliario-y-toldos/" title="cRenta de Mobiliario y toldos =)">Mobiliario y Toldos</a></li>
